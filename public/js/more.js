...
import { state, el, ico } from './core.js';
  ...
  el('view-more').innerHTML = `
    <div class="page">
      ...
      <nav class="more-list" aria-label="More">
        <a href="#/automations">${ico('bolt')}<span><b>Automations</b><small>Order updates, COD, cart and reorder reminders</small></span>${ico('forward')}</a>
